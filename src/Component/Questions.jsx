    ...
    <div className="w-full bg-black/90 py-4 px-8 pb-20">
      <div className="mx-auto flex flex-wrap gap-8 justify-between">
        ...
        <div className="flex-1 rounded-lg p-6 w-full md:w-[60%]">
          <h2 className="text-5xl font-bold mb-4 text-white">DO YOU HAVE QUESTIONS</h2>
          <h3 className="text-5xl font-semibold mb-6 text-white">
            DO NOT WAIT, <span className='text-yellow-500'> LET'S TALK</span>
          </h3>
          <div className='w-full flex flex-wrap gap-12 mt-16'>
            <div className="flex items-center">
              <FaPhone className="text-yellow-500 text-xl mr-4" />
              <span className="text-xl lg:text-3xl text-white">+1 234 567 890</span>
            </div>
            <div className="flex items-center">
              <FaEnvelope className="text-yellow-500 text-sm text-xl mr-4" />
              <span className=" text-xl lg:text-3xl text-white">example@example.com</span>
            </div>
          </div>
        </div>
