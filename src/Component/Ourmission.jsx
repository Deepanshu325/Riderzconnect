    ...
    <div className='bg-black/90 w-full min-h-screen pb-16 max-w-7xl mx-auto'>
      ...
      <div className='flex flex-col lg:flex-row mt-20 lg:space-x-8 space-y-8 lg:space-y-0 px-4'>
        ...
        <div className='w-full lg:w-1/3  overflow-hidden hover:bg-black pt-16 pb-8'>
          ...
          <h1 className='text-white text-2xl text-center mb-6 font-bold hover:text-yellow-500 ' data-aos="fade-right">RIDE OUTS</h1>
          <div className="w-full mx-auto">
            <p className='text-sm text-white/35 text-center font-bold' data-aos="fade-up">
        ...
        <div className='w-full lg:w-1/3  overflow-hidden hover:bg-black pt-16 pb-8'>
          ...
          <h1 className='text-white text-2xl text-center mb-6 font-bold hover:text-yellow-500 ' data-aos="fade-right">SUPPORTS</h1>
          <div className="w-full mx-auto">
            <p className='text-sm text-white/35 text-center font-bold' data-aos="fade-up" >
        ...
        <div className='w-full lg:w-1/3  overflow-hidden hover:bg-black pt-16 pb-8'>
          ...
          <h1 className='text-white text-2xl text-center mb-6 font-bold hover:text-yellow-500 ' data-aos="fade-right">COMMUNITIES</h1>
          <div className="w-full mx-auto">
            <p className='text-sm text-white/35 text-center font-bold' data-aos="fade-up">
