    ...
    const posts = [
        {
          ...
          date: 'April 17, 2019',
          image: 'https://demo2.wpopal.com/lexrider/wp-content/uploads/2019/04/blog-14-100x120.jpg', // Replace with actual image paths
        },
        {
          id: 2,
          title: '15 books every designer needs to read',
          date: 'April 17, 2019',
          image: 'https://demo2.wpopal.com/lexrider/wp-content/uploads/2019/04/blog-14-100x120.jpg',
        },
        {
          id: 3,
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <article>
                        ...
                        <p className="text-gray-300 mb-4">
                            We woke up to prepare for the trip back to Lagos. Breakfast was yam and sauce, yam and egg, and coffee and chocolate drink.
                        </p>
                        <p className="text-gray-300 mb-4">
                            Once we had eaten and everyone was set, we were on board and set out at about 6 am. Our route was via Ondo town, Ore, Ogunpalu, Edo, Ogbemudia farms, Benin, Sagamu, Lagos.
                        </p>
                        <p className="text-gray-300 mb-4">
                            Heading out, we stopped to fill up at the NNPC station in Ore and then set off.
                        </p>
                        ...
                        <p className='text-gray-300'> Of course my guardians were there to sort me out FD and Maestro. Once i sorted out the helmet we rolled off and caught up with the others “they had waited further on” and we continued out of Osogbo through to Ede (nice breezy and fun ride).
                        bg-calltoaction </p>
                        </div>
                    ...
                    <p className='text-gray-300 '>While filtering through the traffic, a pedestrian crossing without any care ran into Dicta’s bike and broke the right side mirror ( I could see fire coming out of RC’s nose and ears fortunately Kanu rode up diffusing the situation).</p>
                </div>
      ...
      <div className="mt-4 h-1 bg-red-500"></div>
                    ...
                    <div className="bg-gray-800 p-4 rounded-lg">
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="text-gray-300 hover:text-white">Uncategorized(14)</a></li>
    ...
    THE REST OF THE JOURNEY THROUGH TO LAGOS WAS COOL. LUCKY FOR US TRAFFIC WAS LIGHT AND WE MADE VERY GOOD TIME. WE ENDED THE JOURNEY AT THE CALDRON IN AJAHSA WITH THANKS TO THE ALMIGHTY FOR JOURNEY MERCIES"
      ...
      <div className="mt-6 ">
        <p className="text-gray-500">
          There was a point where I was overtaking a trailer on the rather rough side of the road and right then the road suddenly went rougher; written man was doing 60, so you increase your speed get past the trailer and bring your bike onto the road...
        </p>
      </div>
